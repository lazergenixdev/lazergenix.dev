...
foreign {
	wgpu_buffer_create :: proc(size: int, usage: BufferUsageFlags) -> Buffer ---
	wgpu_buffer_write_raw :: proc(buffer: Buffer, bytes: [] u8, offset := 0) ---
	...
	wgpu_bind_vertex_buffer :: proc(buffer: Buffer) ---
	wgpu_bind_index_buffer :: proc(buffer: Buffer) ---
}

wgpu_buffer_write :: proc(buffer: Buffer, data: [] $T, offset := 0)
{
	wgpu_buffer_write_raw(buffer, slice.to_bytes(data), offset);
}
...
BufferMapCallback :: #type proc "contextless" (status: MapAsyncStatus, message: StringView, userdata1: rawptr, userdata2: rawptr)
CompilationInfoCallback :: #type proc "contextless" (status: CompilationInfoRequestStatus, compilationInfo: ^CompilationInfo, userdata1: rawptr, userdata2: rawptr)
CreateComputePipelineAsyncCallback :: #type proc "contextless" (status: CreatePipelineAsyncStatus, pipeline: ComputePipeline, message: StringView, userdata1: rawptr, userdata2: rawptr)
CreateRenderPipelineAsyncCallback :: #type proc "contextless" (status: CreatePipelineAsyncStatus, pipeline: RenderPipeline, message: StringView, userdata1: rawptr, userdata2: rawptr)
DeviceLostCallback :: #type proc "contextless" (device: ^Device, reason: DeviceLostReason, message: StringView, userdata1: rawptr, userdata2: rawptr)
PopErrorScopeCallback :: #type proc "contextless" (status: PopErrorScopeStatus, type: ErrorType, message: StringView, userdata1: rawptr, userdata2: rawptr)
QueueWorkDoneCallback :: #type proc "contextless" (status: QueueWorkDoneStatus, userdata1: rawptr, userdata2: rawptr)
RequestAdapterCallback :: #type proc "contextless" (status: RequestAdapterStatus, adapter: Adapter, message: StringView, userdata1: rawptr, userdata2: rawptr)
RequestDeviceCallback :: #type proc "contextless" (status: RequestDeviceStatus, adapter: Device, message: StringView, userdata1: rawptr, userdata2: rawptr)
UncapturedErrorCallback :: #type proc "contextless" (device: ^Device, type: ErrorType, message: StringView, userdata1: rawptr, userdata2: rawptr)
